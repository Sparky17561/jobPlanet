...
function App() {
  ...
  const [currentResumeName, setCurrentResumeName] = useState('Software Engineer Resume');
  const [resumes, setResumes] = useState([
    { id: 1, name: 'Software Engineer Resume', date: '2024-01-15', code: RESUME_TEMPLATES[0].code },
  ...
  const handleSaveResume = () => {
    if (selectedResumeId) {
      setResumes(prevResumes =>
        prevResumes.map(r =>
          r.id === selectedResumeId
            ? { ...r, name: currentResumeName, code: latexCode, date: new Date().toISOString().split('T')[0] }
            : r
        )
      );
      ...
      <div className="main-container">
        ...
        <div className="content-area">
          <InputPanel 
            ...
            onToggleTemplates={() => setIsTemplatesPanelOpen(!isTemplatesPanelOpen)}
          />
